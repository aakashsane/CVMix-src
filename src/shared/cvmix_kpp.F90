...
! !PUBLIC MEMBER FUNCTIONS:
  ...
  public :: cvmix_coeffs_kpp_low_ML


  interface cvmix_coeffs_kpp
    module procedure cvmix_coeffs_kpp_low
    !module procedure cvmix_coeffs_kpp_low_ML ! uses equations discovery shape function
...
!BOC
    ...
    call cvmix_kpp_compute_turbulent_scales(cvmix_one, OBL_depth,         &
      ...
      do kw=2,kwup ! <--this loops gives you shape function for down-gradient and non-local part
        ...
        MixingCoefEnhancement = cvmix_one ! keeping this as 1.0
   ...
   end subroutine cvmix_coeffs_kpp_low_ML
